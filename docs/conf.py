# -*- coding: utf-8 -*-
#
# ganto.acme_tiny documentation build configuration file
...
htmlhelp_basename = 'gantoacme_tinydoc'
...
latex_documents = [
  ('index', 'gantoacme_tiny.tex', u'ganto.acme\\_tiny Ansible Role Documentation',
...
man_pages = [
    ('index', 'ganto.acme_tiny', u'ganto.acme_tiny Ansible Role Documentation',
     [u'Reto Gantenbein'], 1)
]
